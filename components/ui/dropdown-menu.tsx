...
>(({ className, inset, children, ...props }, ref) => (
  <DropdownMenuPrimitive.SubTrigger
    ...
    className={cn(
      ...
      "font-sans text-sm text-popover-foreground outline-none",
...
>(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.Label
    ref={ref}
    className={cn(
      "px-2 py-1.5 font-sans text-sm font-semibold text-popover-foreground",
      inset && "pl-8",
      className
    )}
    {...props}
...
function DropdownMenuShortcut({ className, ...props }: React.HTMLAttributes<HTMLSpanElement>) {
  return (
    <span
      className={cn("ml-auto font-sans text-xs text-muted-foreground tracking-widest opacity-60", className)}
      {...props}
    />
  );
}
